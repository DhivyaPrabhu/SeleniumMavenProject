...
public class SignupPage
{
    ...
    public void verifySignUp(String expectedMessage)
    {
       // Assert.assertEquals(Alertmessage,expectedMessage);
        ...
        {
            System.out.println("Sign up successful: " + Alertmessage);
        }
        else
        {
            System.out.println("Sign up failed: Expected message '" + expectedMessage + "', but got '" + Alertmessage + "'");
            throw new AssertionError("Sign up message does not match expected message.");
        }
