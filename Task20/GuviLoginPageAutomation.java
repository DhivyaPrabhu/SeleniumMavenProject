...
public class GuviLoginPageAutomation
{
    public static void main(String [] args)throws InterruptedException
    {
        ...
        emailid.sendKeys("yalmozhi5342@gmail.com");

        WebElement password= driver.findElement(By.xpath("//input[@id='password']"));
        password.sendKeys("Dhivya123");

        WebElement mobilenumber= driver.findElement(By.xpath("//input[@id='mobileNumber']"));
        mobilenumber.sendKeys("9788276688");
        ...
        loginEmail.sendKeys("yalmozhi5319@gmail.com");

        WebElement loginPassword= driver.findElement(By.xpath("//input[@id='password']"));
        loginPassword.sendKeys("Dhivya123");
