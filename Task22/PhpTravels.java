...
public class PhpTravels
{
    public static void main(String args[]) throws InterruptedException, IOException
    {
        ...
        WebElement BusinessNane = new WebDriverWait(driver, Duration.ofSeconds(10)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@placeholder='Business Name']")));
        BusinessNane.sendKeys("Business");
